...
#define STATUS_IS_STEPPING_BIT    				( 1 << 9)
...
#define DRIVER_STATUS_OT_WARN_MASK 				( 0x400)
#define DRIVER_STATUS_OT_WARN_SHIFT				10
#define DRIVER_STATUS_OT_ERROR_MASK 			( 0x800)
#define DRIVER_STATUS_OT_ERROR_SHIFT			11

#define DRIVER_STATUS_S2GA_MASK 				( 0x1000)
#define DRIVER_STATUS_S2GA_SHIFT				12
#define DRIVER_STATUS_S2GB_MASK 				( 0x2000)
#define DRIVER_STATUS_S2GB_SHIFT				13

#define DRIVER_STATUS_S2VSA_MASK 				( 0x4000)
#define DRIVER_STATUS_S2VSA_SHIFT				14
#define DRIVER_STATUS_S2VSB_MASK 				( 0x8000)
#define DRIVER_STATUS_S2VSB_SHIFT				15

#define DRIVER_STATUS_CS_ACTUAL_MASK 			( 0x1F0000)
#define DRIVER_STATUS_CS_ACTUAL_SHIFT			16

#define DRIVER_STATUS_OLA_MASK 					( 0x20000)
#define DRIVER_STATUS_OLA_SHIFT					21
#define DRIVER_STATUS_OLB_MASK 					( 0x40000)
#define DRIVER_STATUS_OLB_SHIFT					22
