...
; Generated by Alistair Symonds on 9/01/2022 (UTC)
;
[Setup]
...
OutputBaseFilename="SympleAstroFocus Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\SympleAstroFocus"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\SympleAstroFocus"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SympleAstroFocus.Focuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SympleAstroFocus.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SympleAstroFocus.Focuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.SympleAstroFocus.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.SympleAstroFocus.Focuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
